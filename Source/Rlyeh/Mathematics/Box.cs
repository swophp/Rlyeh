...
public struct Box : IEquatable<Box>, IFormattable
{
    ...
    /// <inheritdoc/>
    public readonly override bool Equals(object? obj) => obj is Box value && Equals(value);
    ...
    /// <inheritdoc/>
    public readonly override int GetHashCode() => HashCode.Combine(Left, Top, Front, Right, Bottom, Back);
