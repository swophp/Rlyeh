...
public readonly struct Color4 : IEquatable<Color4>, IFormattable
{
    ...
    public float Chroma()
    {
        Bounds(out var min, out var max, true);
    ...
    {
        var result = VectorUtilities.Multiply(left._value, right._value);
    ...
    {
        var result = VectorUtilities.Multiply(left._value, right);
        return new Color4(result);
    }
    ...
    {
        var result = VectorUtilities.Multiply(right._value, left);
        return new Color4(result);
    }
