...
public struct BoundingBox : IEquatable<BoundingBox>, IFormattable
{
    ...
    {
        var clampedVector = Vector3.Clamp(sphere.Center, Min, Max);
    ...
    public float? Intersects(in Ray ray)
    {
        ...
        else
        {
            ...
            var t1 = (Min.X - ray.Position.X) * inverse;
            var t2 = (Max.X - ray.Position.X) * inverse;
        ...
        else
        {
            ...
            var t1 = (Min.Y - ray.Position.Y) * inverse;
            var t2 = (Max.Y - ray.Position.Y) * inverse;
        ...
        else
        {
            ...
            var t1 = (Min.Z - ray.Position.Z) * inverse;
            var t2 = (Max.Z - ray.Position.Z) * inverse;
    ...
    /// <inheritdoc/>
    public readonly override bool Equals(object? obj) => obj is BoundingBox other && Equals(other);
    ...
    /// <inheritdoc/>
    public readonly override int GetHashCode() => HashCode.Combine(_min, _max);
